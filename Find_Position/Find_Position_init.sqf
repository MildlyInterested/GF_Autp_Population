...
GF_AP_nearbyLocations = nearestLocations [GF_AP_centerPosition, [
	//"NameLocal",
	"NameCityCapital",
	"NameCity",
	"NameVillage"
	], worldsize];
//	copytoclipboard str GF_AP_nearbyLocations;

GF_AP_nearbyLocations_Sea = nearestLocations [GF_AP_centerPosition, ["NameMarine"], worldsize];
//	copytoclipboard str GF_AP_nearbyLocations;
