...
GF_AP_Blacklist_Zone_1 = getMarkerPos "GF_AP_Blacklist_Zone_1";	
GF_AP_Blacklist_Zone_2 = getMarkerPos "GF_AP_Blacklist_Zone_2";
GF_AP_Blacklist_Zone_3 = getMarkerPos "GF_AP_Blacklist_Zone_3";
GF_AP_Blacklist_Zone_4 = getMarkerPos "GF_AP_Blacklist_Zone_4";
GF_AP_Blacklist_Zone_5 = getMarkerPos "GF_AP_Blacklist_Zone_5";




//______________________	GF_AP_Safe_distance_Check	______________________	

GF_AP_Safe_distance_Check = {
...
if (		
	...
	({_x distance _Pos < GF_AP_Units_Spawn_Safe_distance}count playableUnits isEqualTo 0)
	
	//___________________	Add here your Blacklist Zones	___________________
	&& ((_Pos distance GF_AP_Blacklist_Zone_1) > GF_AP_Blacklist_Zone_distance) 
	&& ((_Pos distance GF_AP_Blacklist_Zone_2) > GF_AP_Blacklist_Zone_distance)
	&& ((_Pos distance GF_AP_Blacklist_Zone_3) > GF_AP_Blacklist_Zone_distance) 
	&& ((_Pos distance GF_AP_Blacklist_Zone_4) > GF_AP_Blacklist_Zone_distance)
	&& ((_Pos distance GF_AP_Blacklist_Zone_5) > GF_AP_Blacklist_Zone_distance)
	
	) then {
	GF_AP_Safe_distance_Check_Ok = true;
	GF_AP_Safe_distance_Check_initialized = true;
	...
	if (		
	//___________________	Add Safe Distance from all Players	___________________
	((_Pos distance player) > GF_AP_Units_Spawn_Safe_distance)
