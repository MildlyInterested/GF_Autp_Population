...
//___________________	Infantry_Recon_SF	___________________
...
//___________________	GF_AP_Spawn_Infantry_Recon_SF_Stalk	___________________
...
_Unit = _Group createunit [selectrandom GF_AP_Pool_Infantry_Recon_SF,_Pos_Spawn,[],0,"Can_collide"];
...
//___________________	GF_AP_Spawn_Infantry_Recon_SF_Patrol	___________________
...
//___________________	GF_AP_Spawn_Infantry_Recon_SF_Defend	___________________	
...
//___________________	GF_AP_Spawn_Infantry_Recon_SF_Attack	___________________
...
//___________________	GF_AP_Garrison_Area_Buildings_Infantry_Recon_SF	___________________ 
...
if (!(typeOf _Building in GF_AP_Garrison_Excluded_Buildings)) then {
	...
	_Group = createGroup GF_AP_Enemy_Side;
	_Unit = _Group createunit [selectrandom GF_AP_Pool_Infantry_Recon_SF,_buildingpos,[],0,"Can_collide"];
	[_Unit] JoinSilent _Group;
