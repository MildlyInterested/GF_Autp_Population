...
//___________________	Infantry_Paratroopers	___________________
...
//___________________	GF_AP_Spawn_Infantry_Paratroopers_Stalk	___________________
...
_unit = _Group createunit [selectrandom GF_AP_Pool_Infantry_Paratroopers,_Pos,[],0,"FLY"];
...
//___________________	GF_AP_Spawn_Infantry_Paratroopers_Patrol	___________________
...
//___________________	GF_AP_Spawn_Infantry_Paratroopers_Defend	___________________	
...
//___________________	GF_AP_Spawn_Infantry_Paratroopers_Attack	___________________
...
//___________________	GF_AP_Garrison_Area_Buildings_Infantry_Paratroopers	___________________ 
...
if (!(typeOf _Building in GF_AP_Garrison_Excluded_Buildings)) then {
	...
	_Group = createGroup GF_AP_Enemy_Side;
	_Unit = _Group createunit [selectrandom GF_AP_Pool_Infantry_Paratroopers,_buildingpos,[],0,"Can_collide"];
	[_Unit] JoinSilent _Group;
