...
//___________________	Infantry_Man	___________________
...
//___________________	GF_AP_Spawn_Infantry_Man_Stalk	___________________
...
_Unit = _Group createunit [selectrandom GF_AP_Pool_Infantry_Man,_Pos_Spawn,[],0,"Can_collide"];
...
//___________________	GF_AP_Spawn_Infantry_Man_Patrol	___________________
...
//___________________	GF_AP_Spawn_Infantry_Man_Defend	___________________	
...
//___________________	GF_AP_Spawn_Infantry_Man_Attack	___________________
...
//___________________	GF_AP_Garrison_Area_Buildings_Infantry_Man	___________________ 
...
if (!(typeOf _Building in GF_AP_Garrison_Excluded_Buildings)) then {
	...
	_Group = createGroup GF_AP_Enemy_Side;
	_Unit = _Group createunit [selectrandom GF_AP_Pool_Infantry_Man,_buildingpos,[],0,"Can_collide"];
	[_Unit] JoinSilent _Group;
