...
//___________________	GF_AP_Spawn_Infantry_Stalk	___________________
...
//___________________	GF_AP_Spawn_Infantry_Patrol	___________________
...
//___________________	GF_AP_Spawn_Infantry_Defend	___________________	
...
//___________________	GF_AP_Spawn_Infantry_Attack	___________________
...
//___________________	GF_AP_Garrison_Area_Buildings_Infantry	___________________ 
...
if (!(typeOf _Building in GF_AP_Garrison_Excluded_Buildings)) then {
	...
	_Group = createGroup GF_AP_Enemy_Side;
	_Unit = _Group createunit [selectrandom GF_AP_Pool_Infantry,_buildingpos,[],0,"Can_collide"];
	[_Unit] JoinSilent _Group;
