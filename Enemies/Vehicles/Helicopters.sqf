...
//___________________	Helicopters	___________________
...
//___________________	GF_AP_Spawn_Helicopters_Stalk	___________________
...
waitUntil {
	if (isMultiplayer) then {
		uisleep 1;
		{_x distance2D _Spawned_Helicopter < 600}count playableUnits > 0;
	}else{
		uisleep 1;
...
//___________________	GF_AP_Spawn_Helicopters_Patrol	___________________
...
//___________________	GF_AP_Spawn_Helicopters_Defend	___________________
...
//___________________	GF_AP_Spawn_Helicopters_Attack	___________________
